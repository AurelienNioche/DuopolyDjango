...
(function () {
  ...
  timezoneJS.timezone = new function () {
    ...
    // - `w`: wall clock time (adjust for both time zone and DST offset).
      ...
      //RoundStep 1:  Find applicable rules for this year.
      //
      //RoundStep 2:  Sort the rules by effective date.
      //
      //RoundStep 3:  Check requested date to see if a rule has yet taken effect this year.  If not,
      //
      //RoundStep 4:  Get the rules for the previous year.  If there isn't an applicable rule for last year, then
      // there probably is no current time offset since they seem to explicitly turn off the offset
      // when someone stops observing DST.
      //
      // FIXME if this is not the case and we'll walk all the way back (ugh).
      //
      //RoundStep 5:  Sort the rules by effective date.
      //RoundStep 6:  Apply the most recent rule before the current time.
