...
### Bug fixes ###
 ...
 - Prevented the local insertRoundSteps and fmt variables from becoming global.
...
## Changes ##
 ...
 - RoundStep-wise charting: line charts have a new option "steps" that when set to
